...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { message: @call.message, public: @call.public, subject: @call.subject }
    end
  ...
  test "should update call" do
    put :update, id: @call, call: { message: @call.message, public: @call.public, subject: @call.subject }
    assert_redirected_to call_path(assigns(:call))
  end
